...
const Db = require('mongodb').Db,
    ...
    dbURL = require('../config.js').slidewiki,
    dbName = require('../config.js').slidewiki_db_name,
    co = require('./common');
...
function testDbName(name) {
    return typeof name !== 'undefined' ? name : dbName;
}
...
module.exports = {
    createDatabase: function (dbname) {
        ...
        let myPromise = new Promise(function (resolve, reject) {
            let db = new Db(dbname, new Server(dbURL));
